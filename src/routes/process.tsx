        ...
        <div className="container-page max-w-4xl space-y-16">
          {processSteps.map((step, i) => (
            <Reveal key={step.number} delay={i * 0.05}>
              <div className="grid md:grid-cols-[auto_1fr] gap-8 items-start border-b border-border pb-16 last:border-0 last:pb-0">
                <p
                  className="text-6xl md:text-7xl font-semibold tracking-tight font-mono"
