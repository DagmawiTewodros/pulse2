...
// Fixed parameters for the Purple/Pink theme
const bgColor       = '#090414';
const flameColor    = '#a855f7';
const flameColor2   = '#f472b6';
const flameAmt      = 0.08;
const atmoColor     = '#d8b4fe';
const atmoCount     = 80;
const atmoSize      = 18;
const atmoSpeed     = 0.8;
const colorLow      = '#3b0764';
const colorHigh     = '#c084fc';
const opacity       = 0.15;
const pointSize     = 4.5;
...
export function HeroWaveEffect() {
  ...
  useEffect(() => {
    ...
    pointsObj.layers.enable(LAYERS.ENTIRE_SCENE);
    ...
    motesGeo.setAttribute("size", new THREE.BufferAttribute(sizes, 1));
    ...
    const motesObj = new THREE.Points(motesGeo, atmoMat);
    motesObj.frustumCulled = false;
    motesObj.layers.enable(LAYERS.ENTIRE_SCENE);
    scene.add(motesObj);
    ...
    const animate = () => {
      ...
      motesObj.position.copy(camera.position);
