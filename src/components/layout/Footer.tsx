    ...
    <footer className="border-t border-border bg-[color:var(--surface)]">
      <div className="container-page py-16 grid gap-12 md:grid-cols-4">
        <div>
          ...
          <p className="mt-4 text-sm text-[color:var(--ink-soft)] max-w-xs leading-relaxed">
      ...
      <div className="border-t border-border">
        <div className="container-page py-6 flex flex-col md:flex-row gap-2 items-center justify-between text-xs text-[color:var(--ink-soft)]">
